...
$ResourceGroupName = "tstusceinnmrfrg"
$ADLSName = "tstusceinnmrfadls01"
$VNetResourceGroupName = "tstuscenetrg"
$VNetName = "tstuscevnet01"
$LocTag = "USCE - Central US"
$EnvTag = "TST - Test"
$AppTag = "MRF - Machine Readable FIles"

#DO NOT CHANGE
$LogAnalyticsWs = "/subscriptions/fe0cda9d-4f2d-45bb-9da4-c3b755c9dcef/resourcegroups/prduseaomsrg/providers/microsoft.operationalinsights/workspaces/prduseaomswsfe0cda9d4f" #DO NOT CHANGE
...
New-AzStorageAccount -ResourceGroupName $ResourceGroupName -AccountName $ADLSName -Location $Location -SkuName "Standard_RAGRS" -Kind StorageV2 -EnableHierarchicalNamespace $true -EnableHttpsTrafficOnly $true -AllowBlobPublicAccess $false -MinimumTlsVersion TLS1_2 -NetworkRuleSet (@{bypass="AzureServices";ipRules=(@{IPAddressOrRange="199.117.168.1";Action="allow"},@{IPAddressOrRange="216.206.24.1";Action="allow"},@{IPAddressOrRange="52.242.208.117";Action="allow"},@{IPAddressOrRange="52.158.213.200";Action="allow"},@{IPAddressOrRange="52.232.225.139";Action="allow"},@{IPAddressOrRange="52.177.165.205";Action="allow"});defaultAction="Deny"}) -Tag @{CreatedBy=$CurrentUser.Id;CreatedDate=$CurrentDate;CostCenter=$CostCenter;NS_Location=$LocTag;NS_Environment=$EnvTag;NS_Application=$AppTag} -ErrorAction Stop
